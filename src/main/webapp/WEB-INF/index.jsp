...
<h3>Bienvenue sur ta page d'accueil ${sessionScope.utilisateur}</h3>
...
<div class="container">
	...
	<div class="card-deck mx-auto">
		<c:forEach items="${articlesrecents}" var="article">
		<div class="card text-white bg-danger mb-3 h-100" style="max-width: 28rem;">
  		...
  		<div class="card-body">
    		...
    		<a href="http://localhost:8080/BlogAlexis/article?id=${article.getId_article()}" class="btn btn-primary">Accéder à l'article</a>
  		...
  		<p class="card-footer font-weight-bold text-light"><c:out value="${article.getDate()}"/></p>
  		</div>
  		</c:forEach>
	</div>
</div>
