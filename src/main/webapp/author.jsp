...
<title>Liste des articles de <%= request.getParameter("nom") %></title>
</head>
<body>
...
<table class="table">
  <thead class="thead-dark">
    <tr>
      <th class="text-center">Liste des articles écrits de <%= request.getParameter("nom") %></th>
    </tr>
  </thead>
  <tbody>
      <c:forEach items="${auteur}" var="auteur">
    <tr>
      <th><c:out value="${auteur.getTitre()}"/></th>
    </tr>
    </c:forEach>
  </tbody>
</table>
