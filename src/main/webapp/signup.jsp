...
<div class="container">
<form class="text-center border border-light p-5" action="inscription" method="post">
	<div class="form-group">
		<label>Nom d'utilisateur :</label>
		<input class="form-control mb-4" type="text" name="utilisateur" required>	
	</div>
	<div class="form-group">
		<label>Mot de passe :</label>
		<input class="form-control" type="password" name="mdp" required>	
	</div>
	<button type="submit" class="btn btn-primary">Insription</button>
</form>
</div>
