...
<form class="text-center border border-light p-5" action="" method="post">
	<div class="form-group">
		<label>Auteur :</label>
		<input class="form-control mb-4" type="text" name="auteur" value="<c:out value="${article.getAuteur()}"/>" readonly>
	</div>
	<div class="form-group">
		<label>Titre :</label>
		<input class="form-control" type="text" name="titre" value="<c:out value="${article.getTitre()}"/>">	
	</div>
	<div class="form-group">
		<label>Description :</label>
		<textarea class="form-control" name="description" rows="3"><c:out value="${article.getDescription()}"/></textarea>
	</div>
	<div class="form-group">
		<label>Article :</label>
		<textarea class="form-control" name="texte" rows="5"><c:out value="${article.getTexte()}"/></textarea>
	</div>
	<button type="submit" name="UpdateArticle" class="btn btn-primary">Envoyer</button>
</form>
</div>
